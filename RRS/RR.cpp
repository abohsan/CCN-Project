...
// packet_id 
void calculateTheWaitingTime(int packet_id[], int burstTime[], int waitingTime[]) 
...
void calculateTurnAroundTime(int packet_id[], int burstTime[], int waitingTime[], int tat[]) 
